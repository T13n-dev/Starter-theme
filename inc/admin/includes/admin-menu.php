...
function add_admin_page() {
    // admin menu 
    add_menu_page( 'Theme Options', 'Theme Setting', 'manage_options', 'theme_options', 'func_admin_setting', 'dashicons-admin-generic', 3 );
    ...
    add_submenu_page( 'theme_options', 'Theme Options', 'Options', 'manage_options', 'themes.php?page=main_options');
}
